...
let g:Hs_CommonArguments = [
            ...
            \ {"name": ["--stayOpen"], "nargs": 0, "help": "don't quit Hideseek after accepting an entry"},
            \ [
            ...
            \ ],
            \ [
            \   {"name": ["--top"],        "nargs": 0, "help": "the Hideseek window is at the top of the screen"},
            \   {"name": ["--bottom"],     "nargs": 0, "help": "the Hideseek window is at the bottom of the screen"},
            \   {"name": ["--left"],       "nargs": 0, "help": "the Hideseek window is at the left of the screen"},
            \   {"name": ["--right"],      "nargs": 0, "help": "the Hideseek window is at the right of the screen"},
            \   {"name": ["--belowright"], "nargs": 0, "help": "the Hideseek window is at the belowright of the screen"},
            \   {"name": ["--aboveleft"],  "nargs": 0, "help": "the Hideseek window is at the aboveleft of the screen"},
            \   {"name": ["--fullScreen"], "nargs": 0, "help": "the Hideseek window takes up the full screen"},
            \   {"name": ["--popup"],      "nargs": 0, "help": "the Hideseek window is a popup window or floating window"},
            \ ],
            \ [
            \   {"name": ["--nameOnly"], "nargs": 0, "help": "Hideseek is in NameOnly mode by default"},
            \   {"name": ["--fullPath"], "nargs": 0, "help": "Hideseek is in FullPath mode by default"},
            \   {"name": ["--fuzzy"],    "nargs": 0, "help": "Hideseek is in Fuzzy mode by default"},
            \   {"name": ["--regexMode"],    "nargs": 0, "help": "Hideseek is in Regex mode by default"},
            \ ],
            \ {"name": ["--nowrap"], "nargs": 0, "help": "long lines in the Hideseek window won't wrap"},
            \ [
